...
// import { RlinkedinFill } from "react-icons/ri";
import {
  AiFillYoutube,
  AiFillGithub,
  AiOutlineInstagram,
...
const socialLinks = [
  ...
  //   icon: <RlinkedinFill className="group-hover:text-white w-4 h-5" />,
  // },
];
        ...
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
          <div>
            ...
            <p className="text-[16px] leading-7 font-[400] text-textColour mt-4">
              Copyright @ {year} developed by Sanjay Baro all right reserved.
            </p>
